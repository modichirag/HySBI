...
# if still running
if args.subdata:
    save_path = cfg_path.replace('networks/hybrid/', 'samples/hybrid2_wv_sub/') 
else:
    save_path = cfg_path.replace('networks/hybrid/', 'samples/hybrid2_wv/') 
...
print("shape large, small, cond : ", pk_large_data.shape, wavelets_data.shape, pk_cond.shape)
